              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Link
                    href="/login"
                  >
                    <Button size="lg" className="bg-accent text-accent-foreground shadow-lg hover:bg-accent/90 transition-transform transform hover:scale-105">
                      Get Started
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-start gap-8 sm:grid-cols-2 md:gap-12 lg:grid-cols-3 mt-12">
              <div className="grid gap-1 text-center p-6 rounded-lg hover:bg-card hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
